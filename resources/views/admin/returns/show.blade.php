...
@section('title', 'Détail Retour RMA - ' . $return->rma_number)
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <a href="{{ route('admin.orders.show', $return->order) }}" class="text-primary">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    ...
                                    @if($return->reason_details)
                                        <div class="mt-2 text-muted">{{ $return->reason_details }}</div>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mb-1">{{ $return->user->name }}</h6>
                            @if($return->user->company_name)
                                <div class="text-muted">{{ $return->user->company_name }}</div>
                            @endif
                            <div class="small text-muted">
                                <i class="fas fa-envelope"></i> {{ $return->user->email }}
                                @if($return->user->phone)
                                    | <i class="fas fa-phone"></i> {{ $return->user->phone }}
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col-12 mb-3">
                            <div class="border-bottom pb-3">
                                <h5 class="text-primary mb-0">{{ number_format($return->orderItem->unit_price * $return->quantity_returned, 2) }}</h5>
                        ...
                        <div class="col-12">
                            <div class="pt-3">
                                <h5 class="text-success mb-0">
                                    ...
                                    @else
                                        {{ number_format($return->orderItem->unit_price * $return->quantity_returned, 2) }}
                                    @endif
                                </h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="number"
                               ...
                               step="0.01"
                               min="0"
                               max="{{ $return->orderItem->unit_price * $return->quantity_returned }}"
                               value="{{ $return->orderItem->unit_price * $return->quantity_returned }}">
                        <div class="form-text">Montant maximum: {{ number_format($return->orderItem->unit_price * $return->quantity_returned, 2) }} MAD</div>
                    </div>
                    <div class="mb-3">
...
document.getElementById('approveForm').addEventListener('submit', function(e) {
    ...
    fetch(`/admin/returns/{{ $return->id }}/approve`, {
        method: 'POST',
        body: formData,
        headers: {
...
document.getElementById('rejectForm').addEventListener('submit', function(e) {
    ...
    fetch(`/admin/returns/{{ $return->id }}/reject`, {
        method: 'POST',
        body: formData,
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
...
function updateStatus(status) {
    ...
    if (confirm(confirmMessage)) {
        fetch(`/admin/returns/{{ $return->id }}/update-status`, {
            method: 'POST',
            headers: {
