                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="productTabsContent">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="unit" name="unit"
                                               value="{{ old('unit', $product->unit) }}" placeholder="pcs, kg, l...">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                        ...
                        <div class="tab-pane fade" id="pricing" role="tabpanel">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control"
                                               ...
                                               value="{{ old('tax_rate', $product->tax_rate ?? 19) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                            ...
                            <div class="row" id="sale-fields" style="display: {{ old('on_sale', $product->on_sale) ? 'flex' : 'none' }};">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input type="checkbox" class="form-check-input" id="available_for_order" name="available_for_order"
                                               {{ old('available_for_order', $product->available_for_order ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <label class="form-label mb-0">
                                        ...
                                        <strong>Galerie d'images ({{ $productImages->count() }})</strong>
                                    </label>
                                        ...
                                        <div class="card shadow-sm h-100 image-card">
                                            <div class="position-relative image-wrapper">
                                                <img src="/storage/{{ $image->image_path }}"
                                                     ...
                                                     onerror="this.onerror=null; this.parentElement.innerHTML='<div class=\'alert alert-danger m-2 text-center\' style=\'height:200px;display:flex;align-items:center;justify-content:center;flex-direction:column;\'><i class=\'fas fa-exclamation-triangle fa-2x mb-2\'></i><div>Image non trouvée</div><small class=\'text-muted\'>{{ $image->image_path }}</small></div>'">
                                                ...
                                                <div class="image-overlay">
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            onclick="deleteImage('{{ $product->sku }}', {{ $image->id }})"
                                            ...
                                            <div class="card-body p-2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <small class="text-muted">
                                                        <i class="fas fa-sort me-1"></i>Position: {{ $image->position }}
                                                    </small>
                                                    @if(!$image->is_cover)
                                                    <form method="POST" action="{{ route('admin.products.set-cover', ['product' => $product, 'image' => $image]) }}" class="d-inline">
                                                        @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ean13" name="ean13"
                                               value="{{ old('ean13', $product->ean13) }}" maxlength="13">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="upc" name="upc"
                                               value="{{ old('upc', $product->upc) }}" maxlength="12">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="0.01" class="form-control"
                                                   ...
                                                   value="{{ old('additional_shipping_cost', $product->additional_shipping_cost) }}">
                                            <span class="input-group-text">DT</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="advanced" role="tabpanel">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control font-monospace" id="technical_specs" name="technical_specs"
                                          rows="6">{{ old('technical_specs', $product->technical_specs) }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="features" name="features"
                                          rows="4">{{ old('features', $product->features) }}</textarea>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input type="checkbox" class="form-check-input" id="new_arrival" name="new_arrival"
                                               {{ old('new_arrival', $product->new_arrival) ? 'checked' : '' }}>
        ...
        <div class="col-lg-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('products.show', $product->sku) }}" class="btn btn-outline-info" target="_blank">
                            <i class="fas fa-eye me-2"></i>Voir le produit
                        </a>
                        <a href="{{ route('admin.custom-prices.create') }}?product_id={{ $product->id }}" class="btn btn-outline-warning">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($product->customPrices && $product->customPrices->count() > 0)
                    <div class="mb-2">
                        <small class="text-muted">Prix personnalisés:</small>
                        <div><span class="badge bg-success">{{ $product->customPrices->count() }}</span></div>
                    </div>
                    @endif
                    <div>
