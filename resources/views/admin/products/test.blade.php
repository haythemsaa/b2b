...
<body class="p-5">
    <div class="container">
        ...
        <div class="alert alert-info">
            ...
            <ul>
                <li><strong>Utilisateur connecté :</strong> {{ auth()->check() ? auth()->user()->name : 'Non connecté' }}</li>
                <li><strong>Rôle :</strong> {{ auth()->check() ? auth()->user()->role : 'N/A' }}</li>
                <li><strong>Email :</strong> {{ auth()->check() ? auth()->user()->email : 'N/A' }}</li>
            </ul>
        </div>
        ...
        <div class="mt-4">
            <a href="{{ route('admin.products.edit', 'RIZ-BAS-1KG') }}" class="btn btn-primary">
