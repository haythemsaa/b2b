...
@section('title', 'Analytics SuperAdmin')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="btn-group">
                    ...
                    <a href="{{ route('superadmin.export.analytics', ['format' => 'csv']) }}" class="btn btn-success">
                        <i class="fas fa-download"></i> Export CSV
                    </a>
                    <a href="{{ route('superadmin.export.analytics', ['format' => 'json']) }}" class="btn btn-info">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        @endphp
                        <span class="mr-2">
                            <i class="fas fa-circle text-primary"></i> Grossistes: {{ $grossistes }}
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Vendeurs: {{ $vendeurs }}
                        </span>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $product->name }}</td>
                                    <td>{{ rand(10, 100) }}</td>
                                    <td>{{ number_format($product->price * rand(10, 100), 2) }} DT</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                @endphp
                                @foreach($topVendeurs as $vendeur)
                                <tr>
                                    <td>{{ $vendeur->name }}</td>
                                    <td>{{ $vendeur->orders()->count() }}</td>
                                    <td>{{ number_format($vendeur->orders()->sum('total_amount'), 2) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="border-left-warning p-3">
                                ...
                                <div class="h6 mb-0 font-weight-bold text-gray-800">
                                    {{ \App\Models\ProductReturn::count() }}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 mb-3">
