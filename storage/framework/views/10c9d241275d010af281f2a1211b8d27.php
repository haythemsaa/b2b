...
<?php $__env->startSection('title', 'Modifier le Tarif Personnalisé'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="<?php echo e(route('admin.custom-prices.show', $customPrice)); ?>" class="btn btn-outline-info">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.custom-prices.update', $customPrice)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($product->id); ?>"
                                                ...
                                                <?php echo e(old('product_id', $customPrice->product_id) == $product->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                           id="price"
                                           name="price"
                                           value="<?php echo e(old('price', $customPrice->price)); ?>"
                                           step="0.01"
                                           min="0"
                                           required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        ...
                                        ?>
                                        <input class="form-check-input" type="radio" name="type" id="type_group" value="group" <?php echo e($currentType === 'group' ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="type_user" value="user" <?php echo e($currentType === 'user' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__currentLoopData = $customerGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($group->id); ?>" <?php echo e(old('customer_group_id', $customPrice->customer_group_id) == $group->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php echo e(old('user_id', $customPrice->user_id) == $user->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                       id="min_quantity"
                                       name="min_quantity"
                                       value="<?php echo e(old('min_quantity', $customPrice->min_quantity)); ?>"
                                       min="1">
...
unset($__errorArgs, $__bag); ?>"
                                       id="valid_from"
                                       name="valid_from"
                                       value="<?php echo e(old('valid_from', $customPrice->valid_from?->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                       id="valid_until"
                                       name="valid_until"
                                       value="<?php echo e(old('valid_until', $customPrice->valid_until?->format('Y-m-d'))); ?>">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div class="fw-bold"><?php echo e($customPrice->product->name); ?></div>
                        <div class="text-muted">SKU: <?php echo e($customPrice->product->sku); ?></div>
                    </div>

                    <div class="mb-3">
                        <small class="text-muted">Prix Standard</small>
                        <div><?php echo e(number_format($customPrice->product->price, 2)); ?> MAD</div>
                    </div>

                    <div class="mb-3">
                        <small class="text-muted">Prix Personnalisé Actuel</small>
                        <div class="fw-bold text-success"><?php echo e(number_format($customPrice->price, 2)); ?> MAD</div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2025\htdocs\b2bn\resources\views\admin\custom-prices\edit.blade.php ENDPATH**/ ?>