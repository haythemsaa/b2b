    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card animate__animated animate__fadeInLeft">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-funnel me-2"></i><?php echo e(__('Filters')); ?></h5>
                </div>
                <div class="card-body">
                    <!-- Search Box -->
                    <div class="mb-3">
                        <label class="form-label fw-bold"><?php echo e(__('Search')); ?></label>
                    ...
                    <!-- Sort By -->
                    <div class="mb-3">
                        <label class="form-label fw-bold"><?php echo e(__('Sort By')); ?></label>
                        <select class="form-select" x-model="sortBy" @change="sortProducts()">
                            <option value="name"><?php echo e(__('Name')); ?> (A-Z)</option>
                            <option value="price_asc"><?php echo e(__('Price')); ?> (<?php echo e(__('Low to High')); ?>)</option>
                            <option value="price_desc"><?php echo e(__('Price')); ?> (<?php echo e(__('High to Low')); ?>)</option>
                    ...
                    <!-- View Mode -->
                    <div class="mb-3">
                        <label class="form-label fw-bold"><?php echo e(__('View')); ?></label>
                    ...
                    <!-- Stock Filter -->
                    <div class="mb-3">
                        <label class="form-label fw-bold"><?php echo e(__('Availability')); ?></label>
                ...
                <div class="list-group list-group-flush">
                    <a href="#"
                       ...
                       @click.prevent="category = ''; filterProducts()">
                        <i class="bi bi-grid-3x3-gap me-2"></i><?php echo e(__('All Products')); ?>
                    ...
                    <a href="#"
                       class="list-group-item list-group-item-action transition-all"
                       :class="{ 'active': category == '<?php echo e($cat->id); ?>' }"
                       @click.prevent="category = '<?php echo e($cat->id); ?>'; filterProducts()">
                        <i class="bi bi-tag me-2"></i><?php echo e($cat->name); ?>

                        <span class="badge bg-secondary float-end"><?php echo e($cat->products_count ?? 0); ?></span>
                    </a>
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeInDown">
                <div>
                    <h2><i class="bi bi-box-seam me-2 text-primary"></i><?php echo e(__('Products')); ?></h2>
                    <p class="text-muted mb-0">
                        <span x-text="filteredProducts.length"></span> <?php echo e(__('products found')); ?>
                ...
                <div class="d-flex gap-2">
                    <button class="btn btn-outline-secondary" @click="location.reload()" title="<?php echo e(__('Refresh')); ?>">
            ...
            <div x-show="loading" class="text-center py-5">
                ...
                <p class="text-muted mt-3"><?php echo e(__('Loading products...')); ?></p>
            </div>
                            ...
                            <div class="position-relative overflow-hidden" style="height: 200px;">
                                ...
                                <div class="position-absolute top-0 end-0 m-2">
                                    <span class="badge"
                                        ...
                                        <span x-text="product.stock_quantity > 0 ? '<?php echo e(__('In Stock')); ?>' : '<?php echo e(__('Out of Stock')); ?>'"></span>
                                    </span>
                                </div>
                                ...
                                <div class="overlay">
                                    <a :href="`/products/${product.sku}`"
                                       class="btn btn-light btn-sm">
                                        <i class="bi bi-eye"></i> <?php echo e(__('Quick View')); ?>
                                    ...
                                    <div class="mb-3">
                                        <template x-if="product.user_price && product.user_price != product.price">
                                            <div>
                                                ...
                                                <span class="badge bg-danger ms-1"><?php echo e(__('Promo!')); ?></span>
                                            </div>
                                        </template>
                                        <template x-if="!product.user_price || product.user_price == product.price">
                                    ...
                                    <div class="d-grid gap-2">
                                        <a :href="`/products/${product.sku}`"
                                           class="btn btn-outline-primary btn-sm transition-all scale-hover">
                                            <i class="bi bi-eye me-1"></i><?php echo e(__('View Details')); ?>
                                        ...
                                        <button type="button"
                                            ...
                                            <span x-text="product.stock_quantity > 0 ? '<?php echo e(__('Add to Cart')); ?>' : '<?php echo e(__('Out of Stock')); ?>'"></span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <span class="badge"
                                                  :class="product.stock_quantity > 0 ? 'bg-success' : 'bg-danger'">
                                                <span x-text="product.stock_quantity > 0 ? '<?php echo e(__('In Stock')); ?> (' + product.stock_quantity + ')' : '<?php echo e(__('Out of Stock')); ?>'"></span>
                                            </span>
                                        </div>
                                        <div class="btn-group">
                                            <a :href="`/products/${product.sku}`" class="btn btn-outline-primary btn-sm">
                                                <i class="bi bi-eye"></i> <?php echo e(__('Details')); ?>
                                            ...
                                            <button type="button"
                                                    ...
                                                    :disabled="product.stock_quantity <= 0"
                                                    @click="addToCart(product.id)">
                                                <i class="bi bi-cart-plus"></i> <?php echo e(__('Add to Cart')); ?>
            ...
            <div x-show="!loading && filteredProducts.length === 0"
                ...
                <h4 class="text-muted"><?php echo e(__('No products found')); ?></h4>
                <p class="text-muted"><?php echo e(__('Try adjusting your search criteria')); ?></p>
                <button @click="search = ''; category = ''; filterProducts()" class="btn btn-primary">
                    <i class="bi bi-arrow-counterclockwise me-2"></i><?php echo e(__('Reset Filters')); ?>
...
function productCatalog() {
    return {
        products: <?php echo json_encode($products->items(), 15, 512) ?>,
        filteredProducts: [],
        search: '',
        category: '',
        sortBy: 'name',
        ...
        async addToCart(productId) {
            ...
            try {
                ...
                if (data.success) {
                    notyf.success('<?php echo e(__('Product added to cart!')); ?>');
                    // Update cart count in sidebar
                    window.dispatchEvent(new CustomEvent('cart-updated'));
                } else {
                    notyf.error(data.message || '<?php echo e(__('Error adding to cart')); ?>');
                }
            } catch (error) {
                notyf.error('<?php echo e(__('Error adding to cart')); ?>');
                console.error(error);
            } finally {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2025\htdocs\b2bn\resources\views\products\index.blade.php ENDPATH**/ ?>