<?php $__env->startSection('title', 'Modifier Adresse'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="Domicile" <?php echo e(old('label', $address->label) == 'Domicile' ? 'selected' : ''); ?>>Domicile</option>
                                <option value="Bureau" <?php echo e(old('label', $address->label) == 'Bureau' ? 'selected' : ''); ?>>Bureau</option>
                                <option value="Entrepôt" <?php echo e(old('label', $address->label) == 'Entrepôt' ? 'selected' : ''); ?>>Entrepôt</option>
                                <option value="Magasin" <?php echo e(old('label', $address->label) == 'Magasin' ? 'selected' : ''); ?>>Magasin</option>
                                <option value="Autre" <?php echo e(old('label', $address->label) == 'Autre' ? 'selected' : ''); ?>>Autre</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('full_name', $address->full_name)); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="TN" <?php echo e(old('country', $address->country) == 'TN' ? 'selected' : ''); ?>>Tunisie (TN)</option>
                                <option value="DZ" <?php echo e(old('country', $address->country) == 'DZ' ? 'selected' : ''); ?>>Algérie (DZ)</option>
                                <option value="MA" <?php echo e(old('country', $address->country) == 'MA' ? 'selected' : ''); ?>>Maroc (MA)</option>
                                <option value="FR" <?php echo e(old('country', $address->country) == 'FR' ? 'selected' : ''); ?>>France (FR)</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                      ...
                                      placeholder="Instructions de livraison, code d'accès, etc."><?php echo e(old('notes', $address->notes)); ?></textarea>
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                       ...
                                       value="1" <?php echo e(old('is_default', $address->is_default) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2025\htdocs\b2bn\resources\views\addresses\edit.blade.php ENDPATH**/ ?>