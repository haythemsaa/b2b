<?php $__env->startSection('title', 'Rapports & Statistiques'); ?>
        ...
        <div class="col-md-3">
            <div class="card border-primary">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('admin.reports.sales')); ?>" class="btn btn-primary">
                        Voir le rapport
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-success">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('admin.reports.inventory')); ?>" class="btn btn-success">
                        Voir le rapport
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card border-info">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo e(route('admin.reports.customers')); ?>" class="btn btn-info">
                        Voir le rapport
                    </a>
                </div>
            </div>
                ...
                <div class="card-body text-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.export', 'sales')); ?>">Ventes CSV</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.export', 'products')); ?>">Produits CSV</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('admin.reports.export', 'customers')); ?>">Clients CSV</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.reports.sales')); ?>" class="btn btn-sm btn-primary">Voir</a>
                                        <a href="<?php echo e(route('admin.reports.export', 'sales')); ?>" class="btn btn-sm btn-outline-primary">Export</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.reports.inventory')); ?>" class="btn btn-sm btn-success">Voir</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.reports.customers')); ?>" class="btn btn-sm btn-info">Voir</a>
                                        <a href="<?php echo e(route('admin.reports.export', 'customers')); ?>" class="btn btn-sm btn-outline-info">Export</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2025\htdocs\b2bn\resources\views\admin\reports\index.blade.php ENDPATH**/ ?>