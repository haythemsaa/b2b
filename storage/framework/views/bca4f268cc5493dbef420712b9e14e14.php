        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if($quote->converted_order_id && $quote->convertedOrder): ?>
                        <a href="<?php echo e(route('admin.orders.show', $quote->convertedOrder->order_number)); ?>" class="btn btn-outline-primary w-100 mb-2">
                            <i class="fas fa-shopping-cart"></i> Voir la Commande <?php echo e($quote->convertedOrder->order_number); ?>
